...
sub mf_stringfuncs 
{
    ...
    public String __toPerl() {
        ...
        for (int i = 0; i < size; i++) {
            if (i > 0) sb.append(\",\");
            sb.append(((ConstSF$ft) __vect.elementAt(i)).__toPerl());
        }
        return sb.append("").toString();
    }
EOF
...
foreach (keys %fieldtypes) {
    ...
    # SF class
	startclass("SF$ft", "Field", split ",", $imports{$ft});
    ...
    # ConstSF class
	startclass("ConstSF$ft", "ConstField", split ",", $imports{$ft});
    ...
    # MF class
	startclass("MF$ft", "MField", "java.util.StringTokenizer");
    ...
    # ConstMF class
	startclass("ConstMF$ft", "ConstMField", "java.util.StringTokenizer");
