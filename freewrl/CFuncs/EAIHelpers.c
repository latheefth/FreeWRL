...
/* map an internal node type to EAI type - eg, map SFNODE to EAI_SFNODE... */
int mapInternalToEAItype (indexT internalType) {
	return (internalType + EAI_SFUNKNOWN);
}

/* map a FIELDTYPE to EAI type - FIELDTYPES are generated by VRMLC.pm; EAItypes are
constants used here and in Java code. */
int mapFieldTypeToEAItype (indexT kwIndex) {
	switch (kwIndex) {
...
/* map a FIELDTYPE to internal type - FIELDTYPES are generated by VRMLC.pm; internal types are
constants used here and in other code. */
int mapFieldTypeToInernaltype (indexT kwIndex) {
	switch (kwIndex) {
		case FIELDTYPE_SFFloat: return SFFLOAT;
		case FIELDTYPE_MFFloat: return MFFLOAT;
		case FIELDTYPE_SFRotation: return SFROTATION;
		case FIELDTYPE_MFRotation: return MFROTATION;
		case FIELDTYPE_SFVec3f: return SFVEC3F;
		case FIELDTYPE_MFVec3f: return MFVEC3F;
		case FIELDTYPE_SFBool: return SFBOOL;
		case FIELDTYPE_MFBool: return MFBOOL;
		case FIELDTYPE_SFInt32: return SFINT32;
		case FIELDTYPE_MFInt32: return MFINT32;
		case FIELDTYPE_SFNode: return SFNODE;
		case FIELDTYPE_MFNode: return MFNODE;
		case FIELDTYPE_SFColor: return SFCOLOR;
		case FIELDTYPE_MFColor: return MFCOLOR;
		case FIELDTYPE_SFColorRGBA: return SFCOLORRGBA;
		case FIELDTYPE_MFColorRGBA: return MFCOLORRGBA;
		case FIELDTYPE_SFTime: return SFTIME;
		case FIELDTYPE_MFTime: return MFTIME;
		case FIELDTYPE_SFString: return SFSTRING;
		case FIELDTYPE_MFString: return MFSTRING;
		case FIELDTYPE_SFVec2f: return SFVEC2F;
		case FIELDTYPE_MFVec2f: return MFVEC2F;
		case FIELDTYPE_SFImage: return SFIMAGE;
		case FIELDTYPE_FreeWRLPTR: return FREEWRLPTR;
	}
return 0;
}
