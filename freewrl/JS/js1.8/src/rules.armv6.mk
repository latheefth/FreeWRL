...
$(OBJDIR)/jsinterp.o: jsinterp.c jsinterp.h
	@$(MAKE_OBJDIR)
	$(CC) -o $@ -arch armv6 -no_compact_linkedit -miphoneos-version-min=2.2 -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS3.1.2.sdk -c $(INTERP_CFLAGS) jsinterp.c
