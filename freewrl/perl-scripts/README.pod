=head1 NAME - README for perl scripts in vrml files

This file contains some information on perl scripting in vrml 97/2.0
code and examples. As of today, 2000/10/05, they work with CVS
freewrl. They should work with freewrl-0.27 when it gets out.
...
I prefer to put scripts in C<PROTO> nodes, for modularity. The
following code (from F<simple-2.wrl>) implements a sphere that changes
color when clicked upon
