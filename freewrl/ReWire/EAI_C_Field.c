...
X3DNode *X3D_newSFString(){printf ("New node not implemented yet for this type\n");return NULL;}
...
X3DNode *X3D_newMFColor(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFFloat(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFTime(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFInt32(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFString(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFNode(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFRotation(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFVec2f(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFVec3f(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFColorRGBA(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFBool(){printf ("New node not implemented yet for this type\n");return NULL;}
X3DNode *X3D_newMFVec3d(){printf ("New node not implemented yet for this type\n");return NULL;}
