...
pts.push_back(pt(-1.179225,0.400000,-0.793838)); pts.push_back(pt(-2.596795,0.200000,-0.616889)); pts.push_back(pt(-2.685269,0.200000,-1.325674));
pts.push_back(pt(-2.685269,0.200000,-1.325674)); pts.push_back(pt(-1.267700,0.500000,-1.502623)); pts.push_back(pt(-1.179225,0.400000,-0.793838));
pts.push_back(pt(0.149871,0.000000,-1.679572)); pts.push_back(pt(-1.179225,0.400000,-0.793838)); pts.push_back(pt(-1.267700,0.500000,-1.502623));
pts.push_back(pt(-1.179225,0.400000,-0.793838)); pts.push_back(pt(0.149871,0.000000,-1.679572)); pts.push_back(pt(0.238345,0.000000,-0.970787));
pts.push_back(pt(1.655915,0.000000,-1.147736)); pts.push_back(pt(0.238345,0.000000,-0.970787)); pts.push_back(pt(0.149871,0.000000,-1.679572));
pts.push_back(pt(0.149871,0.000000,-1.679572)); pts.push_back(pt(1.567440,0.300000,-1.856521)); pts.push_back(pt(1.655915,0.000000,-1.147736));
pts.push_back(pt(-1.179225,0.400000,-0.793838)); pts.push_back(pt(-2.508320,0.400000,0.091896)); pts.push_back(pt(-2.596795,0.200000,-0.616889));
pts.push_back(pt(-2.508320,0.400000,0.091896)); pts.push_back(pt(-1.179225,0.400000,-0.793838)); pts.push_back(pt(-1.090750,0.000000,-0.085053));
pts.push_back(pt(0.238345,0.000000,-0.970787)); pts.push_back(pt(-1.090750,0.000000,-0.085053)); pts.push_back(pt(-1.179225,0.400000,-0.793838));
pts.push_back(pt(-1.090750,0.000000,-0.085053)); pts.push_back(pt(0.238345,0.000000,-0.970787)); pts.push_back(pt(0.326820,0.000000,-0.262002));
pts.push_back(pt(1.744389,0.000000,-0.438951)); pts.push_back(pt(0.326820,0.000000,-0.262002)); pts.push_back(pt(0.238345,0.000000,-0.970787));
pts.push_back(pt(0.238345,0.000000,-0.970787)); pts.push_back(pt(1.655915,0.000000,-1.147736)); pts.push_back(pt(1.744389,0.000000,-0.438951));
pts.push_back(pt(-1.090750,0.000000,-0.085053)); pts.push_back(pt(-2.419846,0.300000,0.800681)); pts.push_back(pt(-2.508320,0.400000,0.091896));
pts.push_back(pt(-2.419846,0.300000,0.800681)); pts.push_back(pt(-1.090750,0.000000,-0.085053)); pts.push_back(pt(-1.002276,0.000000,0.623732));
pts.push_back(pt(0.415295,0.000000,0.446783)); pts.push_back(pt(-1.002276,0.000000,0.623732)); pts.push_back(pt(-1.090750,0.000000,-0.085053));
pts.push_back(pt(-1.090750,0.000000,-0.085053)); pts.push_back(pt(0.326820,0.000000,-0.262002)); pts.push_back(pt(0.415295,0.000000,0.446783));
pts.push_back(pt(1.832864,0.000000,0.269834)); pts.push_back(pt(0.415295,0.000000,0.446783)); pts.push_back(pt(0.326820,0.000000,-0.262002));
pts.push_back(pt(0.326820,0.000000,-0.262002)); pts.push_back(pt(1.744389,0.000000,-0.438951)); pts.push_back(pt(1.832864,0.000000,0.269834));
...
void display(void)
{
    ...
    /*draw tri*/
     ...
     glColor3f(.6,.6,.6);
     glVertex3dv(&pts[activepts[0]/3 *3+1].x);
     glVertex3dv(&pts[activepts[0]/3 *3+0].x);
     glVertex3dv(&pts[activepts[0]/3 *3+2].x);
     glEnd();
    ...
    struct pt disp = get_poly_normal_disp(y1,y2,r,&pts[activepts[0]/3 *3],3,pt(0,0,0));
