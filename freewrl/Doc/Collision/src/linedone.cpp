...
*/
     ...
     struct pt disp;
     disp = get_line_normal_disp(-1,1,r,pts[0],pts[1],n);
     ...
     glBegin(GL_LINES);
     glColor3f(0.,0.5,0.);
     glVertex3d(pts[0].x+disp.x,pts[0].y+disp.y,pts[0].z+disp.z);
     glVertex3d(pts[1].x+disp.x,pts[1].y+disp.y,pts[1].z+disp.z);
     glEnd();
