...
#define FIELDNAMES___rsouth	666
#define FIELDNAMES_appearance	667
#define FIELDNAMES_autoOffset	668
#define FIELDNAMES_wrapT	669
#define FIELDNAMES_zDimension	670
#define FIELDNAMES_maxDelta	671
#define FIELDNAMES__floatOutFIFO	672
#define FIELDNAMES__intControllerType	673
#define FIELDNAMES__normal	674
#define FIELDNAMES_entitySubCategory	675
#define FIELDNAMES_set_coordIndex	676
#define FIELDNAMES_munitionQuantity	677
#define FIELDNAMES__stringOutFIFO	678
#define FIELDNAMES_elapsedTime	679
#define FIELDNAMES_numPoints	680
#define FIELDNAMES___vertices	681
#define FIELDNAMES___initialized	682
...
struct X3D_GeoOrigin {
	...
	struct SFVec3d __oldgeoCoords;
	struct SFVec3d __reast;
	struct SFVec3d __rsouth;
	struct SFVec3d __rup;
	struct SFVec3d geoCoords;
	struct Multi_String geoSystem;
	struct X3D_Node *metadata;
	int rotateYUp;
