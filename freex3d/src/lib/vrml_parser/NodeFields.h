...
EXPOSED_FIELD(AudioControl,source,sfstring,source,FIELDTYPE_SFString)
EVENT_OUT(AudioControl,panInt32Val,sfint32,panInt32Val,FIELDTYPE_SFInt32)
EVENT_OUT(AudioControl,deltaFloatVal,sffloat,deltaFloatVal,FIELDTYPE_SFFloat)
EVENT_OUT(AudioControl,volumeInt32Val,sfint32,volumeInt32Val,FIELDTYPE_SFInt32)
EXPOSED_FIELD(AudioControl,direction,sfvec3f,direction,FIELDTYPE_SFVec3f)
EXPOSED_FIELD(AudioControl,maxFront,sffloat,maxFront,FIELDTYPE_SFFloat)
EXPOSED_FIELD(AudioControl,maxDelta,sffloat,maxDelta,FIELDTYPE_SFFloat)
EXPOSED_FIELD(AudioControl,metadata,sfnode,metadata,FIELDTYPE_SFNode)
EXPOSED_FIELD(AudioControl,enabled,sfbool,enabled,FIELDTYPE_SFBool)
EXPOSED_FIELD(AudioControl,maxBack,sffloat,maxBack,FIELDTYPE_SFFloat)
EXPOSED_FIELD(AudioControl,minFront,sffloat,minFront,FIELDTYPE_SFFloat)
EXPOSED_FIELD(AudioControl,location,sfvec3f,location,FIELDTYPE_SFVec3f)
EVENT_OUT(AudioControl,isActive,sfbool,isActive,FIELDTYPE_SFBool)
EVENT_OUT(AudioControl,panFloatVal,sffloat,panFloatVal,FIELDTYPE_SFFloat)
EXPOSED_FIELD(AudioControl,minBack,sffloat,minBack,FIELDTYPE_SFFloat)
EXPOSED_FIELD(AudioControl,intensity,sffloat,intensity,FIELDTYPE_SFFloat)
EVENT_OUT(AudioControl,deltaInt32Val,sfint32,deltaInt32Val,FIELDTYPE_SFInt32)
EVENT_OUT(AudioControl,volumeFloatVal,sffloat,volumeFloatVal,FIELDTYPE_SFFloat)
...
EXPOSED_FIELD(MidiControl,channel,sfint32,channel,FIELDTYPE_SFInt32)
EXPOSED_FIELD(MidiControl,highResolution,sfbool,highResolution,FIELDTYPE_SFBool)
EXPOSED_FIELD(MidiControl,velocity,sfint32,velocity,FIELDTYPE_SFInt32)
EXPOSED_FIELD(MidiControl,controller,sfstring,controller,FIELDTYPE_SFString)
EXPOSED_FIELD(MidiControl,pressLength,sffloat,pressLength,FIELDTYPE_SFFloat)
FIELD(MidiControl,deviceMaxVal,sfint32,deviceMaxVal,FIELDTYPE_SFInt32)
FIELD(MidiControl,deviceMinVal,sfint32,deviceMinVal,FIELDTYPE_SFInt32)
EXPOSED_FIELD(MidiControl,metadata,sfnode,metadata,FIELDTYPE_SFNode)
EXPOSED_FIELD(MidiControl,floatValue,sffloat,floatValue,FIELDTYPE_SFFloat)
EXPOSED_FIELD(MidiControl,buttonPress,sfbool,buttonPress,FIELDTYPE_SFBool)
EXPOSED_FIELD(MidiControl,controllerPresent,sfbool,controllerPresent,FIELDTYPE_SFBool)
EXPOSED_FIELD(MidiControl,maxVal,sfint32,maxVal,FIELDTYPE_SFInt32)
EXPOSED_FIELD(MidiControl,minVal,sfint32,minVal,FIELDTYPE_SFInt32)
EXPOSED_FIELD(MidiControl,controllerType,sfstring,controllerType,FIELDTYPE_SFString)
EXPOSED_FIELD(MidiControl,deviceName,sfstring,deviceName,FIELDTYPE_SFString)
EXPOSED_FIELD(MidiControl,intValue,sfint32,intValue,FIELDTYPE_SFInt32)
EXPOSED_FIELD(MidiControl,autoButtonPress,sfbool,autoButtonPress,FIELDTYPE_SFBool)
EXPOSED_FIELD(MidiControl,pressTime,sftime,pressTime,FIELDTYPE_SFTime)
EXPOSED_FIELD(MidiControl,useIntValue,sfbool,useIntValue,FIELDTYPE_SFBool)
...
EXPOSED_FIELD(TextureProperties,texturePriority,sfint32,texturePriority,FIELDTYPE_SFInt32)
