...
void *createNewX3DNode (int nt) {
	...
	switch (nt) {
		...
		case NODE_Inline : {
			...
			tmp2->bboxCenter.c[0] = 0;tmp2->bboxCenter.c[1] = 0;tmp2->bboxCenter.c[2] = 0;;
			tmp2->_parentResource = getInputResource();
printf ("inline create, parentResource is %lx\n",tmp2->_parentResource);
{resource_item_t * dd = getInputResource();
printf ("and, as a void is %lx\n",dd);
printf ("parentResource is of size %d\n",sizeof(tmp2->_parentResource));
}
