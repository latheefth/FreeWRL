...
#define SHADERFLAGS_VOLUME_STYLE_OPACITY	1
#define SHADERFLAGS_VOLUME_STYLE_BLENDED	2
#define SHADERFLAGS_VOLUME_STYLE_BOUNDARY	3
#define SHADERFLAGS_VOLUME_STYLE_CARTOON	4
#define SHADERFLAGS_VOLUME_STYLE_COMPOSED	5
#define SHADERFLAGS_VOLUME_STYLE_EDGE		6
#define SHADERFLAGS_VOLUME_STYLE_PROJECTION	7
#define SHADERFLAGS_VOLUME_STYLE_SHADED		8
#define SHADERFLAGS_VOLUME_STYLE_SILHOUETTE	9
#define SHADERFLAGS_VOLUME_STYLE_TONE		10
/*******************************************************/
