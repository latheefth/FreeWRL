...
#define WANT_TEXALPHA 0x04000
#define WANT_ANAGLYPH 0x08000
...
#define USER_DEFINED_SHADER_START	0x01000000 //0x001000
#define USER_DEFINED_SHADER_MASK    0xFF000000 //0x0FF000
