...
#define SHADERFLAGS_VOLUME_DATA_ISO			0x002
#define SHADERFLAGS_VOLUME_DATA_SEGMENT		0x004
#define SHADERFLAGS_VOLUME_STYLE_OPACITY	0x008
#define SHADERFLAGS_VOLUME_STYLE_BLENDED	0x010
#define SHADERFLAGS_VOLUME_STYLE_BOUNDARY	0x020
#define SHADERFLAGS_VOLUME_STYLE_CARTOON	0x040
#define SHADERFLAGS_VOLUME_STYLE_COMPOSED	0x080
#define SHADERFLAGS_VOLUME_STYLE_EDGE		0x100
#define SHADERFLAGS_VOLUME_STYLE_PROJECTION	0x200
#define SHADERFLAGS_VOLUME_STYLE_SHADED		0x400
#define SHADERFLAGS_VOLUME_STYLE_SILHOUETTE	0x800
#define SHADERFLAGS_VOLUME_STYLE_TONE		0x1000
