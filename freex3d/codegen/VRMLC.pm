...
sub gen {
	...
	#	@EAIHeader,	../src/libeai/X3DNode.h
	...
	open GENFUNC, ">../src/lib/scenegraph/GeneratedCode.c";
	print GENFUNC '
...
';
	...
	#####################
	# print out generated functions to a file
	open GENFUNC, ">../src/libeai/X3DNode.h";
	print GENFUNC '
...
';
	...
	#####################
	# print out generated functions to a file
	open GENFUNC, ">../src/libeai/GeneratedCode.c";
	print GENFUNC '
...
';
	...
	open FIELDNODES, ">../src/lib/vrml_parser/NodeFields.h";
	print FIELDNODES '
/*
=INSERT_TEMPLATE_HERE=
...
';
	...
	open STRUCTS, ">../src/lib/vrml_parser/Structs.h";
	print STRUCTS '
/*
=INSERT_TEMPLATE_HERE=
